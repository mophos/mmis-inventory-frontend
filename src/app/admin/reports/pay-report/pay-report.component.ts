...
export class PayReportComponent implements OnInit {
  ...
  excelReportReq() {
    ...
    const startDate = this.startDate ? moment(this.startDate.jsdate).format('YYYY-MM-DD') : null;
    const endDate = this.endDate ? moment(this.endDate.jsdate).format('YYYY-MM-DD') : null;
    const url = `${this.apiUrl}/report/pay-req/excel/${startDate}/${endDate}/${this.warehouseId}/${this.warehouseName}?token=${this.token}&reqTypeId=${reqTypeId}`;
  ...
  excelReportIssue() {
    ...
    const startDate = this.startDate ? moment(this.startDate.jsdate).format('YYYY-MM-DD') : null;
    const endDate = this.endDate ? moment(this.endDate.jsdate).format('YYYY-MM-DD') : null;
    const url = `${this.apiUrl}/report/pay-issue/excel/${startDate}/${endDate}/${this.warehouseId}/${this.warehouseName}?token=${this.token}&transectionId=${transectionId}`;
    window.open(url, '_blank');
  }
  getWarehouseList() {
