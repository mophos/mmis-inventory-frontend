...
@Component({
  selector: 'wm-modal-receive-approve-other',
  templateUrl: './modal-receive-approve-other.component.html',
  styles: []
})
export class ModalReceiveApproveOtherComponent implements OnInit {
